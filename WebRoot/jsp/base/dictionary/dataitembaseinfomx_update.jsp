		...
		<div class="span10">
			<div class="row-fluid">
			        <ul class="breadcrumb">
			          ...
			          <li class="active">${navigation}>>编辑</li>
			        </ul>
		      </div>
			<form method="post"  id="addForm"  action="${pageContext.request.contextPath}/api/dictionary/modifyMx" >
				...
				<div class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="span2" name="dataItemName" value="${dataItemBaseInfo.dataItemName}"  maxlength="50" placeholder="请填写名称"/>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="personName"><span style="color: Red">*&nbsp;</span>值：</label>
						<div class="controls">
							<input type="text" class="span2" name="dataItemValue" value="${dataItemBaseInfo.dataItemValue}" size="30"   maxlength="50"  placeholder="请填写值"/>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
						<input type="text" name="p1" value="${dataItemBaseInfo.p1}" size="30"  class="span2" maxlength="40"/><span ></span>
						</div>
					</div>
						<div class="control-group">
						<label class="control-label" for="personName">属性2：</label>
						<div class="controls">
						<input type="text" name="p2" value="${dataItemBaseInfo.p2}" size="30"  class="span2" maxlength="40"/><span ></span>
						</div>
					</div>
						<div class="control-group">
						<label class="control-label" for="personName">属性3：</label>
						<div class="controls">
						<input type="text" name="p3" value="${dataItemBaseInfo.p3}" size="30"  class="span2" maxlength="40"/><span ></span>
						</div>
					</div>
						<div class="control-group">
						<label class="control-label" for="personName">属性4：</label>
						<div class="controls">
						<input type="text" name="p4" value="${dataItemBaseInfo.p4}" size="30"  class="span2" maxlength="40"/><span ></span>
						</div>
					</div>
						<div class="control-group">
						<label class="control-label" for="personName">属性5：</label>
						<div class="controls">
						<input type="text" name="p5" value="${dataItemBaseInfo.p5}" size="30"  class="span2" maxlength="40"/><span ></span>
						</div>
					</div>
						<div class="control-group">
						<label class="control-label" for="personName">属性6：</label>
						<div class="controls">
						<input type="text" name="p6" value="${dataItemBaseInfo.p6}" size="30"  class="span2" maxlength="40"/><span ></span>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<textarea onkeyup="textCounter('memo','relable','200');" id="memo" name="memo"  rows="3">${dataItemBaseInfo.memo}</textarea>
						</div>
					</div>
