...
function goBack() {
	  window.location.href = "${pageContext.request.contextPath}/api/org/getInfo?id=${postInfo.orgId}";
}
...
<body>
	<div class="span11">
		<div class="ListBlock">
		    		<ul class="breadcrumb">
			          <li class="active">修改岗位</li>
			        </ul>
			</div>
			<!-- 增加组织 -->
			<form method="post"  id="addForm"  action="${pageContext.request.contextPath }/api/org/modifyPostInfo" >
			...
			<div class="form-horizontal">
	        	<div class="control-group">
					...
					<div class="controls">
						<input type="text" value="${postInfo.postName }"  name="postName" class="span2" id="postName" maxlength="50" placeholder="请输入岗位名称"/>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<textarea onkeyup="textCounter('postDuties','relable','500');" rows="6" cols="39" name="postDuties" id="postDuties">${postInfo.postDuties }</textarea>
					</div>
				</div>
