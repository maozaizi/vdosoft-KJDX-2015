...
<body>
	<div class="span11">
		<div class="ListBlock">
			...
			<!-- 添加人员 -->
			<form method="post"  id="addForm"  action="${pageContext.request.contextPath }/api/org/modifyUserInfo" >
			...
			<div class="form-horizontal">
	        	<div class="control-group">
					...
					<div class="controls">
						<input type="text" value="${userInfo.name}" name="name" class="span2" id="name" maxlength="25" placeholder="请输入姓名"/>
					</div>
				</div>
				<div class="control-group">
	        	...
	        	<div class="control-group">
					...
					<div class="controls">
						<input type="text" value="${userInfo.nation}" name="nation" class="span2" id="nation" maxlength="20" placeholder="请输入民族"/>
					</div>
				</div>
	        	<div class="control-group">
					<label class="control-label" for="personName">身份证号码</label>
					<div class="controls">
						<input type="text" value="${userInfo.idcardNumber}" name="idcardNumber" class="span2" id="idcardNumber" placeholder="请输入身份证号码" onblur="setBirthdayByIdNo()"/>
					</div>
				</div>
				<div class="control-group">
               		<label class="control-label" for="personName">出生日期</label>
					<div class="controls">
					    <input size="10" type="text" value="${userInfo.birthData}" class="span2"  name="birthData" id="birthData" readonly/>
               		</div>
				...
				<div class="control-group">
					...
					<div class="controls" >
						<select class="span2" name="degree" id="degree">
							...
							-->
							<c:forEach var="item" items="${web:getDataItem('DEGREETYPE')}">
								<option value="${item.dataItemValue}" ${userInfo.degree == item.dataItemValue ?"selected='selected'":""}>${item.dataItemName}</option>
							</c:forEach>
						</select>
					</div>
	        	...
	        	<div class="control-group">
					...
					<div class="controls">
						<input type="text" value="${userInfo.professional}" name="professional" class="span2" id="professional" maxlength="20" placeholder="请输入专业"/>
					</div>
				</div>
	        	<div class="control-group">
					<label class="control-label" for="personName">职务</label>
					<div class="controls">
						<input type="text" value="${userInfo.position}"  name="position" class="span2" id="position" maxlength="40" placeholder="请输入职务"/>
					</div>
				</div>
	        	<div class="control-group">
